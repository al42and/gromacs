...
static inline void gmx_sfree_impl(const char* name, const char* file, int line, T* ptr)
{
    ...
    static_assert((std::is_trivial<T>::value && std::is_standard_layout<T>::value) || std::is_void<T>::value,
